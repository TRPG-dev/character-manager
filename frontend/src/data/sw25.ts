...
},
{
    ...
    "category": "選択",
    "requirements": "なし",
    "effect": "習得時に「**」にソードやアックスなどの武器カテゴリを1つ選びます。対応カテゴリの武器で攻撃する場合、ダメージが +1 されます。また、対応カテゴリの Aランク武器を装備可能になります。",
    "other": "別枠を使えば別カテゴリの武器習熟も可能。例：武器習熟A/ソード"
},
{
    "name": "武器習熟S/**",
    "category": "選択",
    "requirements": "冒険者レベル5以上, 同カテゴリの武器習熟A/**",
    "effect": "対応カテゴリの武器で攻撃する場合、ダメージが +2（Aと合計で +3）されます。",
    "other": "その他の条件は武器習熟A/**と同じ。"
},
{
    "name": "踏みつけ",
    "category": "選択",
...
},
{
    ...
    "category": "選択",
    "requirements": "なし",
    "effect": "習得時に「**」に金属鎧や盾などの防具カテゴリを1つ選びます。対応カテゴリの防具を装備しているとき、防護点が +1 されます。また、対応カテゴリの Aランク防具を装備可能になります。",
...
},
{
    ...
    "category": "選択",
    "requirements": "なし",
    "effect": "習得者は〈魔法拡大すべて〉を宣言し、〈魔法拡大/数〉と他の〈魔法拡大/**〉を組み合わせた効果を得るとき、対象ごとにどれをどの拡大率で組み合わせるかを別々に定めることができます。また、そのときのMP消費は対象ごとの宣言に応じて決めた後に足し算されます。",
...
},
{
    ...
    "category": "選択",
    "requirements": "冒険者レベル5以上",
    "effect": "習得時に「**」に「ソーサラー」「プリースト」などの魔法使い系技能を1つ選択します。対応した技能で魔法を行使する際、消費MPが−1されます（最低1）。《魔法拡大/**》による拡大時は、この軽減を先に適用してから倍加して最終MP消費を計算します。",
...
},
{
    "name": "魔法拡大/すべて",
    "category": "選択",
    "requirements": "任意の<魔法拡大/**>",
    "effect": "この特技を宣言した手番において、すべての魔法行使に対して、任意の<魔法拡大/**>の効果を得るか選択できます。習得していない拡大も使用可能です。また、複数の拡大を組み合わせることも可能で、それぞれの拡大の係数を乗算して消費MPを計算します。",
    "other": ""
},
{
    "name": "魔法収束",
