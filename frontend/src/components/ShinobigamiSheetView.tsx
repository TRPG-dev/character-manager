            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))', gap: '1rem' }}>
              {(sheetData.ninpo || []).map((ninpo, index) => (
                ...
                >
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                    <div>
                      <div style={{ fontSize: '0.75rem', color: '#6c757d' }}>タイプ</div>
                    ...
                    <div>
                      <div style={{ fontSize: '0.75rem', color: '#6c757d' }}>間合い</div>
                      <div style={{ fontWeight: 'bold' }}>{ninpo.range || '-'}</div>
                    </div>
                    <div>
                      <div style={{ fontSize: '0.75rem', color: '#6c757d' }}>コスト</div>
                      <div style={{ fontWeight: 'bold' }}>{ninpo.cost || '-'}</div>
                    </div>
                    {ninpo.page && (
                      <div>
                        <div style={{ fontSize: '0.75rem', color: '#6c757d' }}>参照ページ</div>
