...
import { SHINOBI_SCHOOLS, getEnemyFromUpperSchool } from '../data/shinobigamiSkills';
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
      ...
      <div style={{ borderTop: '1px solid #ddd', paddingTop: '1.5rem' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: '1rem' }}>
          {(system === 'cthulhu6' || system === 'cthulhu7') && 'occupation' in data && (
            <>
              <div>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => {
                    ...
                    const enemy = upperSchool ? getEnemyFromUpperSchool(upperSchool) : '';
                    const updated = { 
                      ...shinobigamiData, 
                      upperSchool,
                      school: upperSchool,
